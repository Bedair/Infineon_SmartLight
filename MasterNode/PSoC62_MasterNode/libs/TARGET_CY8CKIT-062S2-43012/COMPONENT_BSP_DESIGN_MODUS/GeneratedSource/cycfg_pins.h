...
#endif
#define CYBSP_LED_RGB_GREEN_HSIOM ioss_0_port_0_pin_5_HSIOM
#define CYBSP_USER_LED4_HSIOM CYBSP_LED_RGB_GREEN_HSIOM
#define CYBSP_LED_RGB_GREEN_IRQ ioss_interrupts_gpio_0_IRQn
#define CYBSP_USER_LED4_IRQ CYBSP_LED_RGB_GREEN_IRQ
#if defined (CY_USING_HAL)
    #define CYBSP_LED_RGB_GREEN_HAL_PORT_PIN P0_5
...
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_LED_RGB_GREEN_HAL_DIR CYHAL_GPIO_DIR_BIDIRECTIONAL 
    #define CYBSP_USER_LED4_HAL_DIR CYBSP_LED_RGB_GREEN_HAL_DIR
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_LED_RGB_GREEN_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_STRONG
